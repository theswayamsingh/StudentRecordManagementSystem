...
import os, sys, ast
from sqlalchemy import create_engine as ce    # pip install sqlalchemy
    ...
    def toggle_win():
        ...
        def records():
            ...
            if username in dict.keys() and dict[username]==password:
                ...
                messagebox.showwarning('Access Denied!', 'Only Admins have access to records.')
        ...
        def marksheet():
            ...
            def tb_window():
                ...
                def new_tb():
                    ...
                    create_tb_frame = Frame(win, bg='cornflowerblue', width=370, height=235, relief=GROOVE,
                                            borderwidth=4)
                    create_tb_frame.place(x=300, y=180)
            ...
            def sql_window():
                ...
                def sql_connect():
                    ...
                    try:
                        connection.execute(text('create database srms_marksheet'))
                        connection.execute(text('use srms_marksheet'))
                    except:
                        connection.execute(text('use srms_marksheet'))
        ...
        def about():
            ...
            canvas.create_text(20, 128, text='this software is designed to manage the data', font=('Consolas', 16),
                               fill='white', anchor=W)
            canvas.create_text(20, 158, text='of students, including records and marksheet.', font=('Consolas', 16),
                               fill='white', anchor=W)
            ...
            #                    font=('Consolas', 16), fill='white', anchor=W)
            canvas.create_text(20, 382, text='1) Gmail : theswayamsingh@gmail.com', font=('Consolas', 16),
                               fill='white', anchor=W)
            canvas.create_text(20, 410, text='3) Github : theswayamsingh', font=('Consolas', 16), fill='white', anchor=W)
        ...
        bttn(0, 135, 'R E C O R D S', 'cornflowerblue', 'royalblue', records)
